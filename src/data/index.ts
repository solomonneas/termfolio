...
import {
  ...
  getProjectSOCStack, getProjectOpsDeck, getProjectCodeSearch, getProjectOpenClawGuides,
  getProjectLinuxLabs, getProjectPortGrid,
  getProjectNetworkObservability, getProjectSambaAD, getProjectAPT44, getProjectWaterSecurity,
  getProjectSolomonNeasDev,
  getProjectCyberBRIEF, getProjectBroHunter, getProjectPlaybookForge, getProjectIntelWorkbench,
...
const registry: Record<string, () => string> = {
  ...
  'project:soc-stack': getProjectSOCStack,
  'project:ops-deck': getProjectOpsDeck,
  'project:code-search': getProjectCodeSearch,
  'project:openclaw-guides': getProjectOpenClawGuides,
  // removed laim
  ...
  'project:playbook-forge': getProjectPlaybookForge,
